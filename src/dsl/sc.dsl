...
ethics_a         = _{ t_ethics ~ i ~ primor }
ethics_b         = _{ t_ethics ~ i ~ primor ~ i ~ feedback }
ethics_c         = _{ t_ethics ~ i ~ primor ~ i ~ signature }
ethics_d         = _{ t_ethics ~ i ~ primor ~ i ~ signature ~ i ~ feedback }
t_ethics         = _{ "ethics" }
